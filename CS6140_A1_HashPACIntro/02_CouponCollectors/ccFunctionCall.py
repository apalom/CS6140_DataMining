...
# function call
from couponcollector import couponcollector
...
for n in range(1, nMax, 50):
    [trials, completeSet, r, k, timeExec] = couponcollector(n, nMax, m, timeExec)
    print(n)
    nStep.append(n)
...
plt.xlabel("Domain (n)")
plt.ylabel("Time (s)")
plt.title("Coupon Collector Time Trials m = {}".format(m))
plt.grid(True)
plt.show()
